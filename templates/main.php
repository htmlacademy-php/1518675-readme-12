        ...
        <section class="authorization">
          ...
          <form class="authorization__form form" action="index.php" method="post">
            <div class="authorization__input-wrapper form__input-wrapper <?= isset($errors['login']) ? 'form__input-section--error' : ''; ?>">
              <input class="authorization__input authorization__input--login form__input" type="text" name="login" placeholder="Логин" value="<?= !empty($_POST['login']) ? htmlspecialchars($_POST['login']) : ''; ?>">
            ...
            <div class="authorization__input-wrapper form__input-wrapper <?= isset($errors['password']) ? 'form__input-section--error' : ''; ?>">
              ...
              <span class="form__error-label" <?= isset($errors['password']) ? 'style="position: static; font-size: 16px;"' : ''; ?>><?= $errors['password']; ?></span>
            </div>
